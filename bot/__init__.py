...
try:
    ...
    log_info("CHANNEL_USERNAME not provided..! Using default @h2dts")
    CHANNEL_USERNAME = "SourcePleaseML"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @h2dts")
    FSUB_CHANNEL_ID = -1001523739263
